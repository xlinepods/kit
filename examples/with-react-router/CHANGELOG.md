...
- 060e074: Security update: upgraded React, React Router, Vite, and related dependencies to patch critical vulnerabilities.
...
- 5e78c74: Upgraded `wagmi` to `^2.15.2` and `viem` to `2.29.2`
